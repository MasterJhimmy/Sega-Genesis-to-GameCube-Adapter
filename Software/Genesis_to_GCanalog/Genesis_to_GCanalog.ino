...
//This version converts the dpad inputs of the Genesis controller to a full push in the 
//respective direction on the GameCube analog stick
#include <Gamecube.h>
...
void output_write()
{
     x = 128;
     y = 128;
     X1 = ((currentState & SC_BTN_LEFT)  ? 1 : 128);
     X2 = ((currentState & SC_BTN_RIGHT)  ? 255 : 128);
     switch (X1){
      case 1:
       x = 1;
       break;
     ...
     Y1 = ((currentState & SC_BTN_UP)    ? 255 : 128);
     Y2 = ((currentState & SC_BTN_DOWN)  ? 1 : 128);
